...
const recommendations = [
  {
    icon: <FaTooth className="text-5xl xl:text-7xl text-teal-600" />,
  ...
  {
    icon: <FaLeaf className="text-5xl xl:text-7xl text-green-600" />,
  ...
  {
    icon: <FaSmile className="text-5xl xl:text-7xl text-yellow-500" />,
  ...
  {
    icon: <FaTooth className="text-5xl xl:text-7xl text-blue-500" />,
        ...
        >
          ...
          <div className="absolute inset-0 bg-white/70 border border-teal-100 rounded-xl shadow p-4 backface-hidden">
            ...
            >
              ...
              <h3 className="font-semibold xl:text-2xl line-clamp-2 text-teal-800 text-md">{item.name}</h3>
              <p className="flex-grow text-sm xl:text-xl text-gray-600 leading-snug">
              ...
              <GradientButton>
                <button
                  onClick={handleFlip}
                  className="w-full py-2 cursor-pointer xl:text-xl"
                >
                  Learn More
                </button>
              </GradientButton>
          ...
          <div className="absolute inset-0 bg-teal-700 text-white p-4 rounded-xl [transform:rotateY(180deg)] backface-hidden flex flex-col justify-center items-center">
            ...
            >
              ...
              <p className="flex-grow text-sm my-3 xl:text-lg overflow-y-auto slim-scrollbar">{item.tip}</p>
              <button
                onClick={handleFlip}
                className="bg-white text-teal-700 font-semibold px-4 py-2 rounded-full mt-1 cursor-pointer xl:text-xl"
              >
                Go Back
              </button>
            </div>
